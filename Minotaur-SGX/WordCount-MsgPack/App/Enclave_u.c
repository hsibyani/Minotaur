...
sgx_status_t enclave_spout_execute(sgx_enclave_id_t eid, int* j, int* n)
{
	sgx_status_t status;
	ms_enclave_spout_execute_t ms;
	ms.ms_j = j;
	ms.ms_n = n;
...
sgx_status_t enclave_splitter_execute(sgx_enclave_id_t eid, char* csmessage, int* slength, char* tag, int* n, StringArray* retmessage, word_len retlen, int* nc, MacArray* mac, int* pRoute)
{
	sgx_status_t status;
	ms_enclave_splitter_execute_t ms;
	ms.ms_csmessage = csmessage;
	ms.ms_slength = slength;
	ms.ms_tag = tag;
	ms.ms_n = n;
	ms.ms_retmessage = retmessage;
	ms.ms_retlen = (word_len *)&retlen[0];
	ms.ms_nc = nc;
	ms.ms_mac = mac;
	ms.ms_pRoute = pRoute;
...
sgx_status_t enclave_count_execute(sgx_enclave_id_t eid, char* csmessage, int* slength, char* gcm_tag)
{
	sgx_status_t status;
	ms_enclave_count_execute_t ms;
	ms.ms_csmessage = csmessage;
	ms.ms_slength = slength;
...
sgx_status_t enclave_top_execute(sgx_enclave_id_t eid, int* n, StringArray* retmessage, word_len retlen, int* nc, MacArray* mac, int* pRoute)
{
	sgx_status_t status;
	ms_enclave_top_execute_t ms;
	ms.ms_n = n;
	ms.ms_retmessage = retmessage;
	ms.ms_retlen = (word_len *)&retlen[0];
	ms.ms_nc = nc;
...
sgx_status_t enclave_aggregate_execute(sgx_enclave_id_t eid, char* csmessage, int* slength, char* gcm_tag)
{
	sgx_status_t status;
	ms_enclave_aggregate_execute_t ms;
	ms.ms_csmessage = csmessage;
	ms.ms_slength = slength;
	ms.ms_gcm_tag = gcm_tag;
