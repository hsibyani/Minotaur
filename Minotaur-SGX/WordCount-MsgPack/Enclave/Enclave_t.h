...
void enclave_splitter_execute(char* csmessage, int* slength, char* tag, int* n, StringArray* retmessage, word_len retlen, int* nc, MacArray* mac, int* pRoute);
void enclave_count_execute(char* csmessage, int* slength, char* gcm_tag);
void enclave_top_execute(int* n, StringArray* retmessage, word_len retlen, int* nc, MacArray* mac, int* pRoute);
