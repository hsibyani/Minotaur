## Setup
IP address and port tuples for Spout and Count bolts should be written in files named `spoutIP` and `countIP` respectively. Examples are availabe in the preexisting files.
